...
/**列数据类型*/
 ...
 public void setType(int type) {
  ...
  {
      int type = 1;
      if(className.equals("java.lang.String") || className.equals("java.sql.Clob"))
          type = 1;
      else
      if(className.equals("java.lang.Integer") || className.equals("java.lang.Byte") || className.equals("java.lang.Short"))
          type = 4;
      else
      if(className.equals("java.lang.Double") || className.equals("java.lang.Float"))
          type = 8;
      else
      if(className.equals("java.lang.Long") || className.equals("java.math.BigInteger"))
          type = -5;
      else
      ...
      if(className.equals("[B") || className.equals("java.sql.Blob"))
          type = -2;
      return type;
  }
